...
public class Options {
	...
	private int clientSendCoreSize;
	...
	private int serverChildSendCoreSize;
	...
	public Options(final File propertiesFile) throws IOException {
        ...
        clientSendCoreSize = Integer.valueOf(properties.getProperty("client.send_core_size"));
        ...
        serverChildSendCoreSize = Integer.valueOf(properties.getProperty("server.child_send_core_size"));
    ...
    public int getServerChildSendCoreSize() {
        return serverChildSendCoreSize;
    }

    public int getClientSendCoreSize() {
        return clientSendCoreSize;
    }
